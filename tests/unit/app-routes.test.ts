...
describe("app routes", () => {
  ...
  it("protects dashboard, programs, calendar, reports, notifications, feedback, and profile, not login or public home", () => {
    ...
    expect(isProtectedAppPath("/feedback")).toBe(true);
    expect(isProtectedAppPath("/feedback/foo")).toBe(true);
